 ...
 *
 * Jaguar com.iusworks.jaguar.thrift.NotificationReport
 *
...
public class NotificationReport implements org.apache.thrift.TBase<NotificationReport, NotificationReport._Fields>, java.io.Serializable, Cloneable, Comparable<NotificationReport> {
  ...
  public NotificationReport setNotificationId(String notificationId) {
    this.notificationId = notificationId;
    return this;
  }
  ...
  public NotificationReport setChannel(String channel) {
    this.channel = channel;
    return this;
  }
  ...
  public NotificationReport setDeviceName(String deviceName) {
  ...
  public int compareTo(NotificationReport other) {
    ...
    lastComparison = Boolean.valueOf(isSetRecvTime()).compareTo(other.isSetRecvTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRecvTime()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NotificationReport(");
    boolean first = true;
