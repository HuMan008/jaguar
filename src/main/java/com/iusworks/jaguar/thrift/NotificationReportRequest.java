 ...
 *
 * Jaguar com.iusworks.jaguar.thrift.NotificationReportRequest
 *
...
public class NotificationReportRequest implements org.apache.thrift.TBase<NotificationReportRequest, NotificationReportRequest._Fields>, java.io.Serializable, Cloneable, Comparable<NotificationReportRequest> {
  ...
  public NotificationReportRequest setSignature(String signature) {
    this.signature = signature;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NotificationReportRequest(");
    boolean first = true;
