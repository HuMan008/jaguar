 ...
 *
 * Jaguar com.iusworks.jaguar.thrift.DevicePlatformVoucher
 *
...
public class DevicePlatformVoucher implements org.apache.thrift.TBase<DevicePlatformVoucher, DevicePlatformVoucher._Fields>, java.io.Serializable, Cloneable, Comparable<DevicePlatformVoucher> {
  ...
  public DevicePlatformVoucher setPlatform(String platform) {
    this.platform = platform;
    return this;
  }
  ...
  public DevicePlatformVoucher setVoucher(String voucher) {
    this.voucher = voucher;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DevicePlatformVoucher(");
    boolean first = true;
