...
public class Device implements org.apache.thrift.TBase<Device, Device._Fields>, java.io.Serializable, Cloneable, Comparable<Device> {
  ...
  public Device(Device other) {
    ...
    if (other.isSetCares()) {
      java.util.Set<String> __this__cares = new java.util.HashSet<String>(other.cares);
    ...
    if (other.isSetDeviceInfo()) {
      java.util.Map<String,String> __this__deviceInfo = new java.util.HashMap<String,String>(other.deviceInfo);
  ...
  public Device setTags(java.util.Set<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public void addToCares(String elem) {
    if (this.cares == null) {
      this.cares = new java.util.HashSet<String>();
    }
    this.cares.add(elem);
  }

  public java.util.Set<String> getCares() {
    return this.cares;
  }

  public Device setCares(java.util.Set<String> cares) {
    this.cares = cares;
    return this;
  }
  ...
  public void putToDeviceInfo(String key, String val) {
    if (this.deviceInfo == null) {
      this.deviceInfo = new java.util.HashMap<String,String>();
    }
  ...
  public Device setDeviceInfo(java.util.Map<String,String> deviceInfo) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CARES:
      if (value == null) {
        ...
        setCares((java.util.Set<String>)value);
      }
      break;
    ...
    case DEVICE_INFO:
      if (value == null) {
        ...
        setDeviceInfo((java.util.Map<String,String>)value);
      }
      break;
  ...
  public int compareTo(Device other) {
    ...
    lastComparison = Boolean.valueOf(isSetDeviceInfo()).compareTo(other.isSetDeviceInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDeviceInfo()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = DeviceType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.tags = new java.util.HashSet<String>(2*_set0.size);
                String _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.cares = new java.util.HashSet<String>(2*_set3.size);
                String _elem4;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.deviceInfo = new java.util.HashMap<String,String>(2*_map9.size);
                String _key10;
                String _val11;
      ...
      if (struct.cares != null) {
        if (struct.isSetCares()) {
          oprot.writeFieldBegin(CARES_FIELD_DESC);
          {
            ...
            for (String _iter14 : struct.cares)
            {
      ...
      if (struct.deviceInfo != null) {
        if (struct.isSetDeviceInfo()) {
          oprot.writeFieldBegin(DEVICE_INFO_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter16 : struct.deviceInfo.entrySet())
            {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (String _iter17 : struct.tags)
          {
      ...
      if (struct.isSetCares()) {
        {
          ...
          for (String _iter18 : struct.cares)
          {
      ...
      if (struct.isSetDeviceInfo()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter20 : struct.deviceInfo.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tags = new java.util.HashSet<String>(2*_set21.size);
          String _elem22;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.cares = new java.util.HashSet<String>(2*_set24.size);
          String _elem25;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.deviceInfo = new java.util.HashMap<String,String>(2*_map30.size);
          String _key31;
          String _val32;
