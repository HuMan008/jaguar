...
public class NotificationHistory implements org.apache.thrift.TBase<NotificationHistory, NotificationHistory._Fields>, java.io.Serializable, Cloneable, Comparable<NotificationHistory> {
  ...
  static {
    schemes.put(StandardScheme.class, new NotificationHistoryStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NotificationHistoryTupleSchemeFactory());
  }
  ...
  public void validate() throws TException {
    ...
    if (mid == null) {
      throw new TProtocolException("Required field 'mid' was not present! Struct: " + toString());
    }
    if (uid == null) {
  ...
  private static class NotificationHistoryStandardSchemeFactory implements SchemeFactory {
    public NotificationHistoryStandardScheme getScheme() {
      return new NotificationHistoryStandardScheme();
    }
  }

  private static class NotificationHistoryStandardScheme extends StandardScheme<NotificationHistory> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NotificationHistory struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NotificationHistory struct) throws TException {
      struct.validate();
  ...
  private static class NotificationHistoryTupleSchemeFactory implements SchemeFactory {
    public NotificationHistoryTupleScheme getScheme() {
      return new NotificationHistoryTupleScheme();
    }
  }

  private static class NotificationHistoryTupleScheme extends TupleScheme<NotificationHistory> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NotificationHistory struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NotificationHistory struct) throws TException {
