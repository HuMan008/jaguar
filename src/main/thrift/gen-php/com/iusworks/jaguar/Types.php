  ...
  public function write($output) {
    ...
    if ($this->tags !== null) {
      ...
      $xfer += $output->writeFieldBegin('tags', TType::SET, 4);
      {
        ...
        {
          foreach ($this->tags as $iter12 => $iter13)
          {
            if (is_scalar($iter13)) {
    ...
    if ($this->cares !== null) {
      ...
      $xfer += $output->writeFieldBegin('cares', TType::SET, 5);
      {
        ...
        {
          foreach ($this->cares as $iter14 => $iter15)
          {
            if (is_scalar($iter15)) {
  ...
  public function write($output) {
    ...
    if ($this->tags !== null) {
      ...
      $xfer += $output->writeFieldBegin('tags', TType::SET, 3);
      {
        $output->writeSetBegin(TType::STRING, count($this->tags));
        {
          foreach ($this->tags as $iter29 => $iter30)
          {
            if (is_scalar($iter30)) {
    ...
    if ($this->ext !== null) {
      ...
      $xfer += $output->writeFieldBegin('ext', TType::MAP, 9);
      {
        ...
        {
          foreach ($this->ext as $kiter31 => $viter32)
          {
